...
export const register=(name,email,password)=>async(dispatch,getState)=>{
    try{
        ...
        const{data}=await axios.post(`/accounts/register/`,{ 'name': name, 'email': email, 'password': password },config)
...
export const updateUserProfile=(user)=>async(dispatch,getState)=>{
    try{
        ...
        const{data}=await axios.put('/accounts/profile/update/',user,config)
